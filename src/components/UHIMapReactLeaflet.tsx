            ...
            <div class="p-3">
              ...
              <div class="text-xs space-y-2">
                ...
                <div class="text-muted-foreground text-xs mt-2">
                  💡 Click within the Thodupuzha region where coverage is available.
                </div>
              </div>
            </div>
          `);
          ...
          loadingPopup.setContent(`
            <div class="p-3">
              ...
              <div class="text-xs space-y-2">
                ...
                <div class="text-muted-foreground text-xs mt-2">
                  🗺️ The analysis is limited to the Thodupuzha study region.
                </div>
              </div>
            </div>
          `);
              ...
              ${errorMessage.includes('outside coverage') ? `
                <div class="mt-2 p-2 bg-yellow-500/10 rounded border border-yellow-500/20">
                  <div class="text-yellow-400 text-xs">
                    💡 Tip: Click within the Thodupuzha region where raster layers are available.
                  </div>
                </div>
              ` : `
                <div class="mt-2">
...
const UHIMapReactLeaflet = ({ layers, opacity, onStatsUpdate, onLocationAnalysis, onAOIAnalysis, drawMode = false }: UHIMapProps) => {
  ...
  // Map center: Thodupuzha, Kerala
  const center: [number, number] = [9.8894, 76.7249];
